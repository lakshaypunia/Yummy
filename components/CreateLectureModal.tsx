...
export function CreateLectureModal({ spaceId, isOpen, onClose }: CreateLectureModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setIsLoading(true);
        try {
            const result = await createLecture(spaceId, title, url);
            if (result.success && result.lecture) {
                close();
                router.push(`/dashboard/spaces/${spaceId}/lectures/${result.lecture.id}`);
            } else {
